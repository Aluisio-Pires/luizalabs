...
return [
     ...
     * Note that Schema builder must implement AluisioPires\SwaggerDocs\Responses\SchemaBuilder
     */
    'schema_builders' => [
        'P' => \AluisioPires\SwaggerDocs\Responses\SchemaBuilders\LaravelPaginateSchemaBuilder::class,
        'SP' => \AluisioPires\SwaggerDocs\Responses\SchemaBuilders\LaravelSimplePaginateSchemaBuilder::class,
    ],
