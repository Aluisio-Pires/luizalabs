...
Route::group([
    ...
    Route::controller(AuthController::class)->name('api.v1.')->group(function (): void {
        Route::post('/login', 'login')->name('auth.login');
        Route::post('/register', [AuthController::class, 'register'])->name('auth.register');
    });

    Route::middleware([EnsureFrontendRequestsAreStateful::class, 'auth:sanctum'])->name('api.v1.')->group(function (): void {
