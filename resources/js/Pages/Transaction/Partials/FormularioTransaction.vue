...
const page = usePage();
Echo.private("Transaction.Report." + page.props.auth.user.id).listen(
    ".transaction.report",
    (e) => {
    ...
    <div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <InputError
                    class="mt-2"
                    v-for="error in form.errors.amount"
                    :message="error"
                />
            </div>
            ...
            <div v-if="form.type === 'transferencia'" class="mt-4">
                <InputLabel
                    for="payee_number"
                    value="Número da conta de destino"
                />
                <TextInput
                    id="payee_number"
                ...
                <InputError
                    class="mt-2"
                    v-for="error in form.errors.payee_number"
                    :message="error"
                />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <PrimaryButton
                    class="ms-4"
                    :class="{ 'opacity-25 cursor-not-allowed': !enableSubmit }"
